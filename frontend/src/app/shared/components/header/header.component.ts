...
export class HeaderComponent implements OnInit, OnDestroy {
  ...
  buildNavItems(cats: Category[]): void {
    ...
    // Per-menu category icons — exact JOS Alukkas names & order, using new navbar/ assets
    const menuCats: Record<string, { label: string; route: string; image: string }[]> = {
      '/gold-jewellery': [
        { label: 'Rings',               route: '/gold-jewellery/rings',        image: '/assets/images/navbar/gold/gold-rings.avif' },
        { label: 'Earrings',            route: '/gold-jewellery/earrings',     image: '/assets/images/navbar/gold/gold-Earrings.avif' },
        { label: 'Pendants',            route: '/gold-jewellery/pendants',     image: '/assets/images/navbar/gold/gold-pendants.avif' },
        { label: 'Necklaces',           route: '/gold-jewellery/necklaces',    image: '/assets/images/navbar/gold/gold-Necklace.avif' },
        { label: 'Bangles & Bracelets', route: '/gold-jewellery/bangles',      image: '/assets/images/navbar/gold/gold-bangles.avif' },
        { label: 'Mangalsutra',         route: '/gold-jewellery/mangalsutras', image: '/assets/images/navbar/gold/mangalsutra.avif' },
        { label: 'Chains',              route: '/gold-jewellery/chains',       image: '/assets/images/navbar/gold/chains.avif' },
        { label: 'Anklets',             route: '/gold-jewellery/anklets',      image: '/assets/images/navbar/gold/anklets.avif' },
      ],
      '/diamond-jewellery': [
        { label: 'Rings',               route: '/diamond-jewellery/rings',     image: '/assets/images/navbar/diamond/diamond-rings.avif' },
        { label: 'Earrings',            route: '/diamond-jewellery/earrings',  image: '/assets/images/navbar/diamond/diamond-earrings.avif' },
        { label: 'Pendants',            route: '/diamond-jewellery/pendants',  image: '/assets/images/navbar/diamond/diamond-pendants.avif' },
        { label: 'Necklaces',           route: '/diamond-jewellery/necklaces', image: '/assets/images/navbar/diamond/diamond-necklace.avif' },
        { label: 'Bangles & Bracelets', route: '/diamond-jewellery/bangles',   image: '/assets/images/navbar/diamond/diamond-bangles.avif' },
        { label: 'Nose Pin',            route: '/diamond-jewellery/nose-pins', image: '/assets/images/navbar/diamond/diamond-nosepin.avif' },
      ],
      '/platinum-jewellery': [
        { label: 'Rings',       route: '/platinum-jewellery/rings',    image: '/assets/images/navbar/platinum/platinum-rings.avif' },
        { label: 'Chains',      route: '/platinum-jewellery/chains',   image: '/assets/images/navbar/platinum/platinum-chain.avif' },
        { label: 'Earrings',    route: '/platinum-jewellery/earrings', image: '/assets/images/navbar/platinum/platinum-earring.avif' },
        { label: 'Bracelets',   route: '/platinum-jewellery/bangles',  image: '/assets/images/navbar/platinum/platinum-bracelet.avif' },
        { label: 'Pendants',    route: '/platinum-jewellery/pendants', image: '/assets/images/navbar/platinum/platinum-pendant.avif' },
        { label: 'Love Bands',  route: '/platinum-jewellery/rings',    image: '/assets/images/navbar/platinum/platinum-lovebands.avif' },
      ],
      '/silver-jewellery': [
        { label: 'Necklaces',           route: '/silver-jewellery/necklaces', image: '/assets/images/navbar/silver/silver-necklace.avif' },
        { label: 'Earrings',            route: '/silver-jewellery/earrings',  image: '/assets/images/navbar/silver/silver-earring.avif' },
        { label: 'Bangles & Bracelets', route: '/silver-jewellery/bangles',   image: '/assets/images/navbar/silver/silver-bracelet.avif' },
        { label: 'Rings',               route: '/silver-jewellery/rings',     image: '/assets/images/navbar/gold/gold-rings.avif' },
      ],
      '/18k-jewellery': [
        { label: 'Rings',               route: '/18k-jewellery/rings',    image: '/assets/images/navbar/gold/gold-rings.avif' },
        { label: 'Pendants',            route: '/18k-jewellery/pendants', image: '/assets/images/navbar/gold/gold-pendants.avif' },
        { label: 'Necklaces',           route: '/18k-jewellery/necklaces',image: '/assets/images/navbar/gold/gold-Necklace.avif' },
        { label: 'Earrings',            route: '/18k-jewellery/earrings', image: '/assets/images/navbar/gold/gold-Earrings.avif' },
        { label: 'Bangles & Bracelets', route: '/18k-jewellery/bangles',  image: '/assets/images/navbar/gold/gold-bangles.avif' },
        { label: 'Anklets',             route: '/18k-jewellery/anklets',  image: '/assets/images/navbar/gold/anklets.avif' },
        { label: 'Second Stud',         route: '/18k-jewellery/earrings', image: '/assets/images/navbar/gold/gold-Earrings.avif' },
      ],
    };
